    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        <View style={styles.searchBoxContainer}>
          <Icon name="search" size={20} color="#000671" style={styles.searchIcon} />
          <TextInput
            style={styles.searchBox}
            placeholder="Search for books..."
            placeholderTextColor="#000671"
            value={searchTerm}
...
const styles = StyleSheet.create({
  ...
  horizontalBookDetails: {
    ...
    position: 'absolute',
    bottom: 0,
    backgroundColor: '#000671', // Darker overlay for better contrast
    width: '100%',
  },
  verticalBookItem: {
    flexDirection: 'row',
    backgroundColor: '#000671', // Slightly darker than white
    borderRadius: 10,
    marginBottom: 10,
    padding: 10,
  },
